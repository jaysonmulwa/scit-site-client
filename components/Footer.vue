<template>
  <footer
    class="bg-white rounded-sm shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800"
  >
    <p
      class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0"
    >
      &copy; 2019-2022
      <a href="https://jkuat.ac.ke/schools/scit/2018/09/12/tukoworks-visiting-jkuat-school-of-computing-and-information-technology/" class="hover:underline" target="_blank"
        >School of Computing 
